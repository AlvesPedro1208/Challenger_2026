...
/**
 * The terminal has no tab of its own, but the tab bar stays on screen under it,
 * so Viagem, Mapa, Bilhete and Pontualidade are always one tap away. The screen
 * therefore carries only the action the moment asks for — the ticket at the
 * gate — and no exit control of its own.
 */
